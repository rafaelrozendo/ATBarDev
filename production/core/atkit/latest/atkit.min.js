(function(h,A){var d=function(){function u(g){this.name=g;this.supportedLanguages=[];this.aboutDialog="";this.settings={};this.version=0;var e=a.$;this.onRender=function(a){};this.onRun=function(a){};this.register=function(){d.registerPlugin(this.name,this)};this.run=function(){this.onRun(e)};this.render=function(){this.onRender(e)}}function v(){k("loadLibrary called");var g=d.internal.__responsiveCssURL,e=document.createElement("link");e.href=g;e.rel="stylesheet";e.type="text/css";e.id="atkit-responsive-css";
document.getElementsByTagName("head")[0].appendChild(e);if("undefined"!=typeof h.jQuery)try{jQversion=parseFloat(h.jQuery().jquery.match(/\d\.\d/));k("jQuery already loaded, v"+jQversion);if(1.5<jQversion){k("loaded version acceptable, using.");a.$=h.jQuery;n();return}h._jQuery=h.jQuery;h.jQuery=null}catch(B){}else"undefined"!=typeof h.$&&(h._$=h.$);d.internal.__debug&&(newVersion=parseFloat(d.internal.__libURL.match(/\d\.\d/)),k("jQuery not loaded, loading "+newVersion));q("atkit-jquery",d.internal.__libURL);
m()}function m(){k("waitForLib invoked");d.internal.__loadAttempts==d.internal.__maxLoadAttempts?(k("Max load count reached: stopping execution."),w()):"undefined"==typeof h.jQuery||null==h.jQuery?(k("waitForLib: jQuery undefined."),setTimeout(function(){m()},100),d.internal.__loadAttempts++):(a.$=h.jQuery.noConflict(!0),"undefined"!=typeof h._jQuery&&(h.jQuery=h._jQuery),"undefined"!=typeof h._$&&(h.$=h._$),a.$(document).ready(function(){n()}))}function n(){k("broadcastLoaded fired.");h.AtKit=a;
"undefined"!=typeof h.AtKitLoaded&&h.AtKitLoaded.fire(null,{version:d.internal.__version})}function x(){k("siteFixes fired. Running fixes.");if(0!=a.__env.siteFixes.length)for(fix in a.__env.siteFixes){var g=a.__env.siteFixes[fix];g.regex.test()&&g.f()}}function r(g){k("renderButton fired for ident "+g+".");var e=a.__templates.button,e=e.replace(/\(ID\)/ig,g),e=e.replace(/\(TITLE\)/ig,a.__env.buttons[g].tooltip),e=e.replace(/\(SRC\)/ig,a.__env.buttons[g].icon),e=e.replace(/\(CLASS\)/ig,a.__env.buttons[g].cssClass),
e=a.$(e);e.children("a").bind("click touchend",{button:a.__env.buttons[g]},function(e){try{a.__env.buttons[g].action(e.data.button.dialogs,e.data.button.functions)}catch(h){d.internal.__debug&&k(h)}e.preventDefault()});e.children("a").bind("focus",function(){a.$(this).attr("style",a.$(this).attr("style")+a.__CSS[".at-btn a:active"])});e.children("a").bind("focusout",function(){a.$(this).attr("style",a.__CSS[".at-btn a"])});a.__env.buttons[g].HTML=e;return a.__env.buttons[g].HTML}function y(){"undefined"==
typeof a.$.facebox&&a.addScript(d.internal.__faceboxURL);if(!d.internal.__invoked){0==a.$("#sbarGhost").length&&t();a.$(a.$("<div>",{id:"sbar"})).insertAfter("#sbarGhost");var g=a.settings.isRightToLeft?"right":"left";a.$(a.$("<a>",{id:"sbarlogo",click:function(){z()}}).append(a.$("<img>",{src:a.settings.logoURL,align:g,border:"0",title:a.settings.name+"Logo",alt:a.settings.name+"Logo",style:"margin-top:10px;float:"+g}))).appendTo("#sbar");a.$("<img>",{src:"https://misc.services.atbar.org/stats/stat.php?channel="+
d.internal.__channel+"-"+a.settings.name+"&version="+d.internal.__version.toFixed(1)+"."+d.internal.__build,alt:" "}).appendTo("#sbar");a.settings.allowclose&&a.addButton("atkit-unload",a.localisation("exit"),d.internal.__assetURL+"img/close.png",function(){a.close()},null,null,{cssClass:"fright"});a.settings.allowreset&&a.addButton("atkit-reset",a.localisation("reset"),d.internal.__assetURL+"img/reset.png",function(){a.reset()},null,null,{cssClass:"fright"});a.settings.allowhelp&&a.addButton("atkit-help",
a.localisation("help"),d.internal.__assetURL+"img/help.png",function(){a.help()},null,null,{cssClass:"fright"});a.$(a.$("<div>",{id:"at-collapse"})).appendTo("#sbar");a.addButton("atkit-toggle",a.localisation("collapse"),d.internal.__assetURL+"img/collapse.gif",function(){$("#at-collapse").is(":visible")?$("#at-collapse").slideUp("fast",function(){$("#at-collapse").addClass("at-hidden");$("#at-collapse").removeClass("at-visible")}):$("#at-collapse").slideDown("fast",function(){$("#at-collapse").addClass("at-visible");
$("#at-collapse").removeClass("at-hidden")})},null,null,{cssClass:"fright"});for(b in a.__env.buttons)"fright"==a.__env.buttons[b].cssClass?a.$(r(b)).appendTo("#sbar"):a.$(r(b)).appendTo("#at-collapse");l();x();"msie"==a.$.browser&&6==a.$.browser.version?a.$("#sbarGhost").remove():a.$("#sbarGhost").html("&nbsp;");d.internal.__invoked=!0;a.__env.global.unloadFn["default"]=function(){a.$("#sbarGhost, #sbar").remove()};a.__env.global.resetFn["default"]=function(){location.reload(!0)};a.$("body").trigger("AtKitRenderComplete")}}
function l(g){g="undefined"==typeof g?a.__CSS:g;for(c in g)if(!/:active/.test(c)&&0!=a.$(c).length)try{var d=g[c];if(a.settings.isRightToLeft)if(-1!=d.indexOf("float:left"))var h=RegExp("float:left","gi"),d=d.replace(h,"float:right");else-1!=d.indexOf("float:right")&&(h=RegExp("float:right","gi"),d=d.replace(h,"float:left"));a.$(c).attr("style",d)}catch(l){k(l.description)}}function z(){d.internal.__aboutDialog.HTML="<h2>About "+a.settings.name+"</h2>";d.internal.__aboutDialog.HTML+="<p id='ATKFBUserSpecifiedAbout'>"+
a.settings.about+"</p>";d.internal.__aboutDialog.HTML+="<p id='ATKFBAboutFooter'>Powered by AtKit "+d.internal.versionString;var g=a.listPlugins();0<g.length&&(d.internal.__aboutDialog.HTML+="<br /> Registered plugins: ",g.map(function(a,g,h){d.internal.__aboutDialog.HTML+="<button class='pluginLink'>"+a+"</button>"}));d.internal.__aboutDialog.HTML+="</p>";d.internal.__aboutDialog.HTML=a.$("<div>",{id:"ATKFBAbout"}).append(d.internal.__aboutDialog.HTML);a.message(d.internal.__aboutDialog.HTML);l(d.internal.__aboutDialog.CSS)}
function k(a){d.internal.__debug&&(null!=d.internal.debugCallback?d.internal.debugCallback(a):"undefined"!=typeof console&&console.log(a))}function t(){barGhost=document.createElement("div");barGhost.id="sbarGhost";barGhost.innerHTML=a.__templates.barGhost;if(null!=document.body)document.body.insertBefore(barGhost,document.body.firstChild);else var g=setInterval(function(){null!=document.body&&(document.body.insertBefore(barGhost,document.body.firstChild),clearInterval(g))},100)}function q(a,d){var h=
document.createElement("script");h.src=d;h.type="text/javascript";h.id=a;document.getElementsByTagName("head")[0].appendChild(h)}function w(){bar=document.getElementById("sbarGhost");bar.innerHTML=a.__templates.barFailed;setTimeout(function(){body=document.getElementsByTagName("body");bar=document.getElementById("sbarGhost");body[0].removeChild(bar)},d.internal.__errorMessageTimeout)}d.internal=d.prototype={__version:1.6,__build:1,__APIVersion:1,__baseURL:"https://core.atbar.org/",__APIURL:"http://a.atbar.org/",
__pluginURL:"https://plugins.atbar.org/",__faceboxURL:"https://core.atbar.org/resources/js/facebox.dev.js",__libURL:"https://core.atbar.org/resources/jquery/1.8/jquery.min.js",__responsiveCssURL:"https://core.atbar.org/resources/css/responsive.css",__channel:"atkit",__invoked:!1,__debug:!1,__loadAttempts:0,__maxLoadAttempts:30,__errorMessageTimeout:2E3,__localStorageNamespace:"AtKit_",__protocol:null,plugins:{},localisations:{en:{exit:"Exit",reset:"Reset webpage",help:"Help & instructions",collapse:"Collapse and uncollapse plugins"},
ar:{exit:"&#1582;&#1585;&#1608;&#1580;",reset:"&#1575;&#1604;&#1605;&#1581;&#1575;&#1608;&#1604;&#1577; &#1605;&#1580;&#1583;&#1583;&#1575;",help:"&#1605;&#1587;&#1575;&#1593;&#1583;&#1577; &#1608; &#1605;&#1593;&#1604;&#1608;&#1605;&#1575;&#1578; &#1575;&#1590;&#1575;&#1601;&#1610;&#1577;",collapse:"&#1593;&#1585;&#1590; &#1571;&#1608; &#1573;&#1582;&#1601;&#1575;&#1569; &#1575;&#1604;&#1604;&#1575;&#1574;&#1581;&#1577;"}},templates:{global:{buttons:{},dialogs:{},storage:{},fn:{},unloadFn:{},helpFn:{},
...
e):q("",d)},addStylesheet:function(d,e){a.$("head").append(a.$("<link>",{rel:"stylesheet",href:d,type:"text/css",id:e}))},addFn:function(d,e){a.__env.global.fn[d]=e},addCloseFn:function(d,e){a.__env.global.closeFn[d]=e},addResetFn:function(d,e){a.__env.global.resetFn[d]=e},addHelpFn:function(d,e){a.__env.global.helpFn[d]=e},addDialog:function(d,e,h){a.__env.global.dialogs[d]={title:e,body:h}},addButton:function(g,e,h,k,n,q,m){"undefined"==typeof a.__env.buttons[g]&&(a.__env.buttons[g]={icon:h,tooltip:e,
action:k,dialogs:n,functions:q},null!=m&&(a.__env.buttons[g]=a.$.extend(!0,a.__env.buttons[g],m)),d.internal.__invoked&&(a.$(r(g)).appendTo("#at-collapse"),l()))},removeButton:function(g){delete a.__env.buttons[g];d.internal.__invoked&&(k("remove button "+g),a.$("#at-btn-"+g).remove())},addSpacer:function(d){"undefined"==typeof d&&a.$(a.__templates.spacer).appendTo("#sbar");if(!isNaN(d))for(i=0;i<d;i++)a.$(a.__templates.spacer).appendTo("#sbar");l()},addSeparator:function(d){"undefined"==typeof d&&
(d="separator"+Math.floor(999*Math.random()+1));var e=a.__templates.separator,e=e.replace(/\(ID\)/ig,d),e=a.$(e);e.appendTo("#at-collapse");l()},removeSeparator:function(g){d.internal.__invoked&&(k("remove separator "+g),a.$(".at-separator-"+g).each(function(){this.remove()}))},importPlugins:function(g,e){var h=g instanceof Array?g.join(","):g;a.addScript(d.internal.__pluginURL+h+".js",e)},addPlugin:function(a){d.internal.plugins[a].payload()},registerPlugin:function(a,e,h){d.internal.plugins[a]=
{payload:e,metadata:h}},listPlugins:function(){var a=[];for(p in d.internal.plugins)a.push(p);return a},getPluginMetadata:function(a){return d.internal.plugins[a].metadata},show:function(d,e){d=a.$("<div>",{"class":"userDialog"}).append(a.$("<h2>",{html:d.title}),a.$("<p>",{html:d.body}));a.$("body").find(".facebox_hide").remove();a.$.facebox(d);l();"null"!=typeof e&&"undefined"!=typeof e&&e()},message:function(d,e){a.$("body").find(".facebox_hide").remove();a.$.facebox(d);l();"null"!=typeof e&&"undefined"!=
typeof e&&e()},hideDialog:function(){a.$(h.document).trigger("close.facebox")},call:function(d,e){return a.__env.global.fn[d](e)},set:function(d,e){a.__env.global.storage[d]=e},get:function(d){return a.__env.global.storage[d]},storageAvailable:function(){return typeof h.localStorage?!0:!1},storage:function(g,e){if(!a.storageAvailable())return!1;var k=d.internal.__localStorageNamespace+a.settings.name+"_"+g;if("undefined"==typeof e)return h.localStorage.getItem(k);h.localStorage.setItem(k,e);return!0},
clearStorage:function(){if(a.storageAvailable()){var g=RegExp("^"+(d.internal.__localStorageNamespace+a.settings.name)+".*");for(s in h.localStorage)s.match(g)&&h.localStorage.removeItem(s)}},setDebugger:function(a){d.internal.debugCallback=a},lib:function(){return"function"==typeof a.$?a.$:"string"==typeof a.$&&"function"==typeof h.jQuery?h.jQuery:!1},render:function(){y()},close:function(){for(f in a.__env.global.unloadFn)a.__env.global.unloadFn[f]();d.internal.language=d.internal.defaultLanguage;
d.internal.debugCallback=null;a.__env.global=d.internal.templates.global;a.__env.buttons={};a.__env.languageMap={};a.__env.siteFixes=[];d.internal.plugins={};d.internal.__invoked=!1},reset:function(){for(f in a.__env.global.resetFn)a.__env.global.resetFn[f]();d.internal.__invoked=!1},help:function(){h.open("http://"+d.internal.language+".wiki.atbar.org/","_blank")}};k("bootstrapping AtKit "+d.internal.versionString+"...");null!=document.getElementById("sbar")||d.internal.__invoked||a.settings.noiframe&&
h!=h.top||("undefined"!=typeof h.AtKitLoaded&&t(),"undefined"==typeof unsafeWindow?d.external.window=h:(d.external.window=unsafeWindow,d.external.transport="GM-XHR"),v());return a};h.AtKit=new d})(window);