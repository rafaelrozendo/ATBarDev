	...
	var AtKit = (function() { 
		...
		var API = {
			...
			__CSS: {
				...
				"#at-btn-atkit-reset, #at-btn-atkit-unload, #at-btn-atkit-help": default_css + "height:28px; width:28px; line-height:14px; text-align:center; color:#FFF; clear:none; float:right; margin:5px 10px 0 0; background:url(" + AtKit.internal.__assetURL + "img/button_background.png) no-repeat;",
