...
var a={__env:d.external,__templates:{barGhost:'<center><img src="'+d.internal.__assetURL+'img/loading.gif" style="margin-top:10px;" /></center>',barFailed:"<center>library loading failed</center>",button:'<div id="at-btn-(ID)" title="(TITLE)" class="at-btn"><a title="(TITLE)" id="at-lnk-(ID)" href="#ATBarLink"><img src="(SRC)" alt="(TITLE)" height="16" width="16" border="0" /></a></div>',spacer:'<div class="at-spacer"></div>',separator:'<div class="at-separator at-separator-(ID)"></div>'},__CSS:{"#sbarGhost, #sbar":default_css,
"#sbarGhost *, #sbar *":default_css,"#sbarlogo":default_css+"float:left","#sbarlogo img":default_css+"margin-top:10px; vertical-align:middle;","#sbar":default_css+"height:40px; left:0; line-height:40px; margin-left:auto; margin-right:auto; position:fixed; top:0;width:100%; z-index:2147483646; padding:0 5px; background:url("+d.internal.__assetURL+"img/background.png) repeat-x #EBEAED;","#sbarGhost":default_css+"height:40px; width:100%;",".at-spacer":default_css+"display:block; height:40px; width:40px; float:left",
".at-separator":default_css+"display:block; height:25px; border-left:2px solid #a9a9a9; margin:7px 1px 4px 7px; float:left;",".at-btn":default_css+"height:28px; width:28px; line-height:14px; text-align:center; color:#FFF; clear:none; margin:5px 0 0 5px;background:url("+d.internal.__assetURL+"img/button_background.png) no-repeat; float:left;",".at-btn a":default_css+"display:block; height:28px; width:28px; background:transparent; position:inherit;",".at-btn a:active":default_css+"font-size: 100%; font: inherit; border:yellow solid 2px;",
".at-btn img":default_css+"padding:6px; default_css + border:none; background:none;","#at-btn-atkit-reset, #at-btn-atkit-unload, #at-btn-atkit-help":default_css+"height:28px; width:28px; line-height:14px; text-align:center; color:#FFF; clear:none; float:right; margin:5px 10px 0 0; background:url("+d.internal.__assetURL+"img/button_background.png) no-repeat;","#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-footer":default_css+"border-top-width: 1px; border-top-style: solid; border-top-color: rgb(221, 221, 221); padding-top:5px; margin-top:10px; display:block; text-align:left;",
"#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-footer > a ":default_css+"float: left;","#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-footer > a > img ":default_css+"float: left;","#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content > .user-dialog > h1":default_css+"font-family:Helvetica Neue,Helvetica,Arial,sans-serif; font-size:18pt; font-weight:bold; color:black; display:block; margin:10px 0px 10px 0px;","#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content h1":default_css+
"font-family:Helvetica Neue,Helvetica,Arial,sans-serif; font-size:18pt; font-weight:bold; color:black; display:block; margin:10px 0px 10px 0px;","#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content h2":default_css+"font-family:Helvetica Neue,Helvetica,Arial,sans-serif; font-size:16pt; font-weight:bold; color:black; display:block; margin:5px 0px 5px 0px;","#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content p":default_css+"display:block;","#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content > .user-dialog > p":default_css+
"display:block;","#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content button":default_css+"font-family:Helvetica Neue,Helvetica,Arial,sans-serif; height:26px; margin:10px; padding:5px; color:white; background-color:#0064CD; border-color:rgba(0,0,0,0.1) rgba(0,0,0,0.1) rgba(0,0,0,0.25); text-shadow:0 -1px 0 rgba(0,0,0,0.25); background-image: -webkit-linear-gradient(top, #049cdb, #0064cd); border-radius:4px;","#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content label":default_css+
"float:left; display:block; margin:0px; margin-right:5px;","#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content select":default_css+"border:1px solid black; float:left; display:block;","#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content input":default_css+"border:1px solid black; float:left; display:block;"},settings:{noiframe:!0,allowclose:!0,allowreset:!0,allowhelp:!0,isRightToLeft:!1,logoURL:"",name:"",about:""},htmlTags:"a abbr acronym address applet area article aside audio b base basefont bdi bdo big blockquote body br button canvas caption center cite code col colgroup command datalist dd del details dfn dir div dl dt em embed fieldset figcaption figure font footer form frame frameset h1 h2 h3 h4 h5 h6 head header hgroup hr html i iframe img input ins kbd keygen label legend li link map mark menu meta meter nav noframes noscript object ol optgroup option output p param pre progress q rp rt ruby s samp script section select small source span strike strong style sub summary sup table tbody td textarea tfoot th thead time title tr track tt u ul var video wbr".split(" "),
