...
(function(window, undefined) {
	...
	var AtKit = (function() { 
		...
		AtKit.internal.__aboutDialog = {
			CSS: {
				"#ATKFBAbout" : "font-family:Helvetica, Verdana, Arial, sans-serif; font-size:12px; color:#364365; direction: ltr; text-align:left; color: initial; background-image: initial; background-color: initial; background: initial;",
				"#ATKFBAbout h2" : "border-bottom:1px solid #DDD; font-size:16px; margin-bottom:5px; margin-top:10px; padding-bottom:5px; direction: ltr; text-align:left; color: initial; background-image: initial; background-color: initial; background: initial;",
				"#ATKFBAbout p#ATKFBAboutFooter" : "border-top:1px solid #DDD;p adding-top:10px; margin-top:25px; color: initial; background-image: initial; background-color: initial; background: initial;",
				"#ATKFBUserSpecifiedAbout": 'color: initial; background-image: initial; background-color: initial; background: initial;',
		...
		var API = {
			...
			__CSS: {
				...
				".at-btn": 'box-sizing: border-box; position: relative; display: block; text-align: center; background: initial; background-color: initial;',
				".at-btn > a": 'box-sizing: border-box; color: rgb(119, 119, 119); background: initial; background-color: initial; display: block; line-height: 20px; padding-bottom: 15px; padding-left: 15px; padding-right: 15px; padding-top: 15px; position: relative; text-decoration: none;',
				
				".at-btn > a > span": 'box-sizing: border-box; color:initial; background: initial; background-color: initial;',
				".at-btn > a > span.glyphicon": '1: top; color:inherit; width: initial; height:initial; text-indent: initial; background-image:initial; background: initial; background-color: initial; -webkit-font-smoothing: antialiased; box-sizing: border-box; display: inline-block; font-family: \'Glyphicons Halflings\'; font-style: normal; font-weight: normal; line-height: 1; position: relative; top: 1px; text-decoration:none;',
				...
				"#at-modal-body": 'box-sizing: border-box; padding-bottom: 15px; width: initial; height: initial; background: initial; background-color: initial; padding-left: 15px; padding-right: 15px; padding-top: 15px; position: relative;',
