	...
	var AtKit = (function() { 
		...
		var API = {
			...
			__CSS: {
				...
				"#at-btn-atkit-reset, #at-btn-atkit-unload, #at-btn-atkit-help": "height:28px; width:28px; line-height:14px; text-align:center; color:#FFF; clear:none; float:right; margin:5px 10px 0 0; background:url(" + AtKit.internal.__assetURL + "img/button_background.png) no-repeat;",
				"#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-footer": "border-top-width: 1px; border-top-style: solid; border-top-color: rgb(221, 221, 221); padding-top: 5px; margin-top: 10px; display: block; text-align: left;",
				"#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-footer > a ": "float: left;",
				"#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-footer > a > img ": "float: left;",
				"#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content > .user-dialog > h1": "font-family:Helvetica Neue,Helvetica,Arial,sans-serif; font-size:18pt; font-weight:bold; color:black; float:left; display:block;",
				"#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content h1": "font-family:Helvetica Neue,Helvetica,Arial,sans-serif; font-size:18pt; font-weight:bold; color:black; float:left; display:block;",
				"#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content h2": "font-family:Helvetica Neue,Helvetica,Arial,sans-serif; font-size:16pt; font-weight:bold; color:black; float:left; display:block;",
				"#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content p": "float:left; display:block;",
				"#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content > .user-dialog > p": "float:left; display:block;",
				...
				"#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content label": "float:left; display:block;",
				"#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content select": "float:left; display:block;",
				"#at-facebox > .at-popup > table .at-fb-tb-body > .at-fb-content input": "float:left; display:block;"
			},
			settings: {
