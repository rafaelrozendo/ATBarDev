if(typeof window['AtKit'] == "undefined"){
	...
	d=document;jf=d.createElement('script');jf.src='http://localhost/production/core/atkit/dev/atkit-local.js';jf.type='text/javascript';jf.id='AtKitLib';d.getElementsByTagName('head')[0].appendChild(jf); 
