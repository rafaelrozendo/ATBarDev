...
(function(){
	...
	var plugin = function(){
		...
		AtKit.addFn('recordSpellng', function(){
			...
			var spellngRecordURL = "/var/www/production/core/atbar/pt/dev/server-services/spell/spellng/record-spellng.php?l=" + AtKit.getLanguage() + "&e=" + spellngIncorrect + "&c=" + spellngCorrection + "&i=" + spellngIgnore + "&s=" + spellngSentance;
			...
			*/
			...
			$lib.SpellChecker.prototype = {
				...
				checkRTESpelling: function(input, rteptr, type){
					...
					$lib.getJSON("/var/www/production/core/atbar/pt/dev/server-services/spell/spellng/spellng.php?l=" + this.options.lang + "&r=" + encodeURIComponent(this.text) + "&callback=?", function(data){
